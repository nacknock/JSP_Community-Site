					...
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100" style="text-align:center">
			      			<h3 class="mb-4">비밀번호를 찾을 아이디 및 이름을 입력해주세요.</h3>
			      		</div>
								
			      	</div>
							<form method="post" action="check_pw_up_Action.jsp" class="signin-form">
		            <div class="form-group mb-3">
		            	<label class="label" for="password">I D</label>
		              <input type="text" class="form-control" name="id" placeholder="ID" required>
		            </div>
		            <div class="form-group">
		            <div class="form-group mb-3">
		            	<label class="label" for="password">이 름</label>
